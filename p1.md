...
_discuss the user research methods you used, provide justification for them_ The three research methods that we chose for our project are:
* Interview
** We selected this method because we think that user accounts are the most effective and useful in obtaining information about fast-passes.
* Survey
