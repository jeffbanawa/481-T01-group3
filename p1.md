...
Recommended features for the system: 
...
__Task 1: User is a ride junkie and wants to go to all rides with the lowest wait time__
...
__Task 4: User is not interested in riding but is responsible for another person that wants to ride__
...
__Task 7: User loses track of time while eating, so they quickly want to check when their next scheduled ride is__
